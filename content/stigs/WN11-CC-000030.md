# STIG ID: [WN11-CC-000030](https://stigaview.com/products/win11/v2r5/WN11-CC-000030/)
...
foreach ($Key in $RegistryValues.Keys) {
    ...
    if ($ConfiguredValue -eq $ExpectedValue) {
        Write-Output "Verification successful: $Key is set to $ConfiguredValue (ICMP redirects disabled)."
    } else {
